...
public class NewUserFavoriteTopicsAdapter extends RecyclerView.Adapter<NewUserFavoriteTopicsAdapter.ViewHolderGroupShower> {


    private final Context context;
    private final ArrayList<Topic> topics;

    public NewUserFavoriteTopicsAdapter(Context context, ArrayList<Topic> topics) {
    ...
    public ViewHolderGroupShower onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.new_user_pick_favorite_topics, parent, false);
        return new ViewHolderGroupShower(view);
    }

    @Override
    public void onBindViewHolder(@NonNull NewUserFavoriteTopicsAdapter.ViewHolderGroupShower holder, int position) {
    ...
    public static class ViewHolderGroupShower extends RecyclerView.ViewHolder {
        ...
        public ViewHolderGroupShower(@NonNull View itemView) {
            super(itemView);
            topic = itemView.findViewById(R.id.new_user_pick_topics_textview);
